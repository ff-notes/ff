            ...
            (note, fs') <-
                evalEither $
                    runStorageSim mempty $
                        cmdNewNote
                            New{text, start, end, isWiki = False, tags}
                            today
            tags' <-
                for
                    [ "7000000001NDU-2000000000012"
                    , "7000000004HKM-2000000000012"
                    ]
                        ...
                        NoteView
                            { note =
                                Note
                                    ...
                                    , note_text =
                                        Just $
                                            RGA "import issues (GitHub -> ff)"
                                    , note_start =
                                        Just $ fromGregorian 2018 06 21
                                ...
                                Map.fromList
                                    [
                                        ( "https://api.github.com/repos\
                                          \/ff-notes/ron/labels/level_Research"
                                        , "level_Research"
                                        )
                                    ,
                                        ( "https://api.github.com/repos\
...
issues =
    pure
        Issue
            ...
            , issueHtmlUrl =
                Just $ URL "https://github.com/ff-notes/ff/issues/60"
